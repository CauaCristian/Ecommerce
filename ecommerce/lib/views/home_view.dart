...
class _HomeState extends State<Home> {
  ...
  void _remove(double id) {
    setState(() {
      _controllerCart.listProductOfCart
        ...
        children: [
          Card(
            elevation: 10,
              child: SizedBox(
            height: 260,
            child: Image.asset("assets/images/bannernoticia.avif"),
          )),
          SizedBox(
            height: 420,
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    trailing: IconButton(
                      onPressed: () {
                        _controllerCart.addProduct(product.name,
                            product.description, product.image, product.value);
                        setState(() {});
                      },
